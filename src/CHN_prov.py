...
CHN_PROV_CODE = [0,11,12,13,14,15,21,22,23,31,32,33,34,35,36,37,41,42,43,44,45,46,50,51,52,53,54,61,62,63,64,65,66,67,68]
...
CHN_PROV_NAME = ['CHINA','BEIJING','TIANJIN','HEBEI','SHANXI','NEIMENGGU','LIAONING','JILIN','HEILONGJIANG','SHANGHAI','JIANGSU','ZHEJIANG','ANHUI','FUJIAN','JIANGXI','SHANDONG','HENAN','HUBEI','HUNAN','GUANGZHOU','GUANGXI','HAINAN','CHONGQING','SICHUAN','GUIZHOU','YUNAN','XIZANG','SHAANXI','GANSU','QINGHAI','NINGXIA','XIJIANG','HONGKONG','MACAO','TAIWAN']
